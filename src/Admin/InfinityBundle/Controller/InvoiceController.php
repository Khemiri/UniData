...
use Admin\InfinityBundle\Entity\Invoice;
use Admin\InfinityBundle\Form\InvoiceType;
...
class InvoiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('InfinityBundle:Invoice')->findAll();
     ...
     * @Method("POST")
     * @Template("InfinityBundle:Invoice:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('InfinityBundle:Invoice')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("InfinityBundle:Invoice:edit.html.twig")
     */
