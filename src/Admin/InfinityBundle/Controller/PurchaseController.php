...
use Admin\InfinityBundle\Form\PurchaseType;
...
class PurchaseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('InfinityBundle:Purchase')->findAll();
     ...
     * @Method("POST")
     * @Template("InfinityBundle:Purchase:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('InfinityBundle:Purchase')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("InfinityBundle:Purchase:edit.html.twig")
     */
